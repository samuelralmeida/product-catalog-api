...
type PasswordResetService struct {
	...
	// O atributo abaixo pode ser usado para facilitar testes
	// Now func() time.Time
}
...
func (prs *PasswordResetService) Create(email string) (*PasswordReset, error) {
	...
	row = prs.DB.QueryRowContext(context.Background(), `
...
func (prs *PasswordResetService) delete(id int) error {
	_, err := prs.DB.ExecContext(context.Background(), `
